...
import com.valentine.learnit.databinding.ActivityMarketingBinding
...
class MarketingActivity : AppCompatActivity() {
    ...
    private val model: MarketingViewModel by viewModels {
        MarketingFactory((application as LearnItApplication).repository)
    }
    private val database = Firebase.database.reference
    private lateinit var firebaseAuth: FirebaseAuth

    private val adapters = MarketingAdapter(ResultComparator)
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.toolbar8.apply {
            ...
            this.setNavigationOnClickListener {
                this@MarketingActivity.onBackPressed()
            }
        }
        ...
        binding.marketingList.apply {
            this.layoutManager = LinearLayoutManager(this@MarketingActivity)
        ...
        lifecycleScope.launch {
            model.getMarketingCourses().collectLatest {
        ...
        adapters.setClickListener(object : OnItemClickedListener {
            override fun onItemClickedListener(result: Result) {
                val intent = Intent(this@MarketingActivity, CourseDashboardActivity::class.java)
