...
class MarketingAdapter(diffCallback: DiffUtil.ItemCallback<Result>) : PagingDataAdapter<Result, MarketingAdapter.MarketingViewHolder>(diffCallback) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MarketingViewHolder {
        return MarketingViewHolder.create(parent, mlistener)
    }
    ...
    class MarketingViewHolder(itemView: View, listener: OnItemClickedListener) : RecyclerView.ViewHolder(itemView) {
        ...
        companion object {
            fun create(parent: ViewGroup, listener: OnItemClickedListener): MarketingViewHolder {
                val view = LayoutInflater.from(parent.context)
                    .inflate(R.layout.list_item, parent, false)

                return MarketingViewHolder(view, listener)
            }
        }
