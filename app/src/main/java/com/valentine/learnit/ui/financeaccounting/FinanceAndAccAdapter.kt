...
class FinanceAndAccAdapter(diffCallback: DiffUtil.ItemCallback<Result>) : PagingDataAdapter<Result, FinanceAndAccAdapter.FinanceAndAccViewHolder>(diffCallback) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FinanceAndAccViewHolder {
        return FinanceAndAccViewHolder.create(parent, mlistener)
    }

    override fun onBindViewHolder(holder: FinanceAndAccViewHolder, position: Int) {
    ...
    class FinanceAndAccViewHolder(itemView: View, listener: OnItemClickedListener) : RecyclerView.ViewHolder(itemView) {
        ...
        companion object {
            fun create(parent: ViewGroup, listener: OnItemClickedListener): FinanceAndAccViewHolder {
                val view = LayoutInflater.from(parent.context)
                    .inflate(R.layout.list_item, parent, false)

                return FinanceAndAccViewHolder(view, listener)
            }
        }
