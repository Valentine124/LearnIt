...
class MusicAdapter(diffCallback: DiffUtil.ItemCallback<Result>) : PagingDataAdapter<Result, MusicAdapter.MusicViewHolder>(diffCallback) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MusicViewHolder {
        return MusicViewHolder.create(parent, mlistener)
    }
    ...
    class MusicViewHolder(itemView: View, listener: OnItemClickedListener) : RecyclerView.ViewHolder(itemView) {
        ...
        companion object {
            fun create(parent: ViewGroup, listener: OnItemClickedListener): MusicViewHolder {
                val view = LayoutInflater.from(parent.context)
                    .inflate(R.layout.list_item, parent, false)

                return MusicViewHolder(view, listener)
            }
        }
