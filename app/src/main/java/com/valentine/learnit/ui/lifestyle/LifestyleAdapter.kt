...
class LifestyleAdapter(diffCallback: DiffUtil.ItemCallback<Result>) : PagingDataAdapter<Result, LifestyleAdapter.LifestyleViewHolder>(diffCallback) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LifestyleViewHolder {
        return LifestyleViewHolder.create(parent, mlistener)
    }
    ...
    class LifestyleViewHolder(itemView: View, listener: OnItemClickedListener) : RecyclerView.ViewHolder(itemView) {
        ...
        companion object {
            fun create(parent: ViewGroup, listener: OnItemClickedListener): LifestyleViewHolder {
                val view = LayoutInflater.from(parent.context)
                    .inflate(R.layout.list_item, parent, false)

                return LifestyleViewHolder(view, listener)
            }
        }
