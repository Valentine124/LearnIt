...
class PhotoAndVideoAdapter(diffCallback: DiffUtil.ItemCallback<Result>) : PagingDataAdapter<Result, PhotoAndVideoAdapter.PhotoAndVideoViewHolder>(diffCallback) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PhotoAndVideoViewHolder {
        return PhotoAndVideoViewHolder.create(parent, mlistener)
    }

    override fun onBindViewHolder(holder: PhotoAndVideoViewHolder, position: Int) {
    ...
    class PhotoAndVideoViewHolder(itemView: View, listener: OnItemClickedListener) : RecyclerView.ViewHolder(itemView) {
        ...
        companion object {
            fun create(parent: ViewGroup, listener: OnItemClickedListener): PhotoAndVideoViewHolder {
                val view = LayoutInflater.from(parent.context)
                    .inflate(R.layout.list_item, parent, false)

                return PhotoAndVideoViewHolder(view, listener)
            }
        }
