...
import com.valentine.learnit.databinding.ActivityOfficeProductivityBinding
...
class OfficeProductivityActivity : AppCompatActivity() {
    private lateinit var binding: ActivityOfficeProductivityBinding
    private val model: OfficeAndProViewModel by viewModels {
        OfficeProFactory((application as LearnItApplication).repository)
    }
    private val database = Firebase.database.reference
    private lateinit var firebaseAuth: FirebaseAuth

    private val adapters = OfficeAndProAdapter(ResultComparator)
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityOfficeProductivityBinding.inflate(layoutInflater)
        val view = binding.root
        setContentView(view)

        binding.toolbar14.apply {
            setSupportActionBar(this)
            supportActionBar?.setDisplayHomeAsUpEnabled(true)
            this.setNavigationOnClickListener {
                this@OfficeProductivityActivity.onBackPressed()
            }
        }
        ...
        binding.officeProList.apply {
            this.layoutManager = LinearLayoutManager(this@OfficeProductivityActivity)
        ...
        lifecycleScope.launch {
            model.getOfficeProCourses().collectLatest {
        ...
        adapters.setClickListener(object : OnItemClickedListener {
            override fun onItemClickedListener(result: Result) {
                val intent = Intent(this@OfficeProductivityActivity, CourseDashboardActivity::class.java)
