...
class OfficeAndProAdapter(diffCallback: DiffUtil.ItemCallback<Result>) : PagingDataAdapter<Result, OfficeAndProAdapter.OfficeAndProViewHolder>(diffCallback) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OfficeAndProViewHolder {
        return OfficeAndProViewHolder.create(parent, mlistener)
    }

    override fun onBindViewHolder(holder: OfficeAndProViewHolder, position: Int) {
    ...
    class OfficeAndProViewHolder(itemView: View, listener: OnItemClickedListener) : RecyclerView.ViewHolder(itemView) {
        ...
        companion object {
            fun create(parent: ViewGroup, listener: OnItemClickedListener): OfficeAndProViewHolder {
                val view = LayoutInflater.from(parent.context)
                    .inflate(R.layout.list_item, parent, false)

                return OfficeAndProViewHolder(view, listener)
            }
        }
